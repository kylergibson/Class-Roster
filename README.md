...
This was for a project for one of my college classes. 

I created this in xcode and then opened the .cpp and .h files in Visual Studio with a VM to compile there. 
